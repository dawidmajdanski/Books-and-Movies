...
({
  init: function(component, event, helper) {
      ...
      if (!$A.util.isUndefinedOrNull(jsonItems)) {
          ...
          let parsedItems = helper.splitResults(component, event, items);
  ...
  handleNextPage: function(component, event, helper){
      ...
      let parsedItems = helper.splitResults(component, event, JSON.parse(sessionStorage.getItem('customSearch--records')));
      component.set('v.products', parsedItems);
  },
